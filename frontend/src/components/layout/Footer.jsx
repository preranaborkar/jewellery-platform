...
const Footer = () => {
  ...
  const categories = [
    ...
    { name: 'Diamond Jewelry', path: '/products?category=diamonds' },
    { name: 'Gold Jewelry', path: '/products?category=gold' },
    { name: 'Silver Jewelry', path: '/products?category=silver' },
    { name: 'Gemstone Jewelry', path: '/products?category=gemstones' }
  ];
          ...
          <div className="text-center">
            ...
            <form className="flex flex-col sm:flex-row max-w-md mx-auto gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-[#E4D4C8] focus:outline-none focus:ring-2 focus:ring-[#E4D4C8] focus:border-transparent"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-[#E4D4C8] hover:bg-white text-[#523A28] font-semibold rounded-full transition-colors duration-300 whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              <Crown className="h-8 w-8 text-[#E4D4C8]" />
              <span className="text-2xl font-bold">SváRIN</span>
            </div>
            
            <p className="text-[#E4D4C8] mb-6 leading-relaxed">
              Crafting timeless elegance since 1995. We specialize in creating exquisite jewelry pieces that celebrate life's most precious moments.
            </p>
            
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <MapPin className="h-5 w-5 text-[#E4D4C8] flex-shrink-0" />
                <span className="text-sm">123 Jewelry District, Mumbai, Maharashtra 400001</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            {/* Business Hours */}
            <div className="mt-8">
              <h5 className="font-semibold mb-3">Store Hours</h5>
              <div className="text-sm text-[#E4D4C8] space-y-1">
      ...
      <div className="border-t border-white/10 bg-[#523A28]">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-xs text-[#E4D4C8]">
